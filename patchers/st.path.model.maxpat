...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 645.0, 830.0, 60.0, 22.0 ],
					"text" : "i"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 645.0, 863.00945999999999, 124.0, 22.0 ],
					"text" : "s compute-path-trans"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1158.393798999999944, 276.212951999999973, 43.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 545.0, 35.0, 30.0, 24.0 ],
					"text" : "B",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1158.393798999999944, 251.212951999999973, 43.0, 24.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1113.393798999999944, 276.212951999999973, 43.0, 24.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1113.393798999999944, 251.212951999999973, 43.0, 24.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1113.393798999999944, 226.212951999999973, 54.599998474121094, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1108.393798999999944, 201.212951999999973, 70.333336770534515, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1108.454895191406194, 171.212951999999973, 62.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1105.0, 135.0, 62.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1113.393798999999944, 306.212951999999973, 75.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 408.393798999999944, 431.212951999999973, 129.51904296875, 23.37556266784668 ],
					"presentation" : 1,
					"presentation_rect" : [ 380.0, 35.0, 185.0, 20.0 ],
					"setminmax" : [ 0.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 373.393798999999944, 391.212951999999973, 86.0, 22.0 ],
					"restore" : [ 0.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 645.0, 765.0, 209.0, 22.0 ],
					"text" : "jit.matrix #1-PATH 3 float32 @adapt 1"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-153",
					"items" : [ "circle", ",", "curve_near_left_rear_front", ",", "diagonal_front_rear", ",", "Etoile-01", ",", "FLocon-01", ",", "FLocon-02", ",", "FLocon-03", ",", "front", ",", "front-curve", ",", "front-side", ",", "front-side-near", ",", "guirlande", ",", "L", ",", "M", ",", "perfect_circle", ",", "snow-flake", ",", "spiral", ",", "square", ",", "straight-Front-Rear" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"rounded" : 0.0,
					"text" : "curve_near_left_rear_front",
					"textcolor" : [ 0.862745, 0.870588, 0.878431, 1.0 ],
					"textjustification" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 645.0, 700.0, 80.0, 22.0 ],
					"text" : "r #0-OnOff"
				}
