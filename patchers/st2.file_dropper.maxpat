...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 461.0, 252.333358999999973, 78.0, 18.0 ],
					"text" : "< MODIFIED",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 498.0, 452.0, 59.0, 20.0 ],
					"text" : "replace $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 226.166672000000005, 126.773482999999999, 66.0, 20.0 ],
					"text" : "s ir.file.load"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 200.0, 195.803223000000003, 62.0, 34.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.5, -2.0, 190.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 888.666687000000024, 262.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 888.666687000000024, 309.727295000000026, 74.0, 20.0 ],
					"text" : "prepend load"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 956.166687000000024, 364.333344000000011, 74.0, 20.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 888.666687000000024, 335.916655999999989, 289.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 87.5, 29.0, 87.0, 54.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 40.0, 301.0, 165.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 377.0, 402.5, 100.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 185.0, 300.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 440.0, 316.333344000000011, 74.0, 20.0 ],
					"text" : "route symbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 377.0, 343.333344000000011, 82.0, 20.0 ],
					"text" : "combine s s"
				}
...
,
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 440.0, 280.333373999999992, 145.0, 31.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 114.363647000000014, 48.0, 364.792175999999984, 20.0 ],
									"text" : "< MODIFIED: connecté directement au regexp 8",
									"textcolor" : [ 1.0, 0.0, 0.0, 1.0 ]
								}
...
,
					"patching_rect" : [ 377.0, 251.333359000000002, 82.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 377.0, 369.5, 69.0, 20.0 ],
					"text" : "setitem 0 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 87.5, 354.5, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 101.5, 231.5, 71.0, 20.0 ],
					"text" : "s ---MuteWet"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 87.5, 200.5, 33.0, 20.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 87.5, 167.5, 53.0, 20.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 267.5, 326.0, 63.0, 20.0 ],
					"text" : "s ---Reload"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 177.5, 167.5, 57.0, 20.0 ],
					"text" : "zl change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.5, 131.0, 61.0, 20.0 ],
					"text" : "r ---Reload"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 87.5, 263.5, 40.0, 20.0 ],
					"text" : "del 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 87.5, 131.0, 109.0, 20.0 ],
					"text" : "t b s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 87.5, 297.482544000000019, 199.0, 20.0 ],
					"text" : "file_loading"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 87.5, 326.0, 74.0, 20.0 ],
					"text" : "prepend load"
				}
...
,
					"patching_rect" : [ 87.5, 93.0, 87.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 498.0, 483.166655999999989, 111.0, 20.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 965.666687000000024, 435.0, 787.0, 435.0, 787.0, 6.0, 186.0, 6.0, 186.0, 7.0, 97.0, 7.0 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 187.0, 238.0, 386.5, 238.0 ],
					"order" : 0,
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-26", 0 ],
					"midpoints" : [ 22.0, 158.75, 97.0, 158.75 ],
					"source" : [ "obj-47", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-50", 0 ],
					"midpoints" : [ 898.166687000000024, 384.0, 779.0, 384.0, 779.0, 14.0, 186.0, 14.0, 186.0, 15.0, 97.0, 15.0 ],
					"source" : [ "obj-7", 0 ]
				}
