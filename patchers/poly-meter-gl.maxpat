...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 59.0, 34.0, 91.0, 22.0 ],
					"text" : "rsval #1-enable"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 110.625122000000033, 76.002869000000146, 101.0, 22.0 ],
...
,
					"patching_rect" : [ 59.0, 106.647125000000017, 70.625122000000005, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 273.5, 449.0, 82.0, 22.0 ],
					"text" : "prepend color"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 273.5, 477.0, 69.0, 22.0 ],
					"text" : "append 0.8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 84.0, 428.0, 84.0, 22.0 ],
					"text" : "prepend scale"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 146.0, 246.0, 53.0, 22.0 ],
					"text" : "slide 0 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 34.0, 468.0, 30.0, 22.0 ],
					"text" : "in 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 145.5, 151.12133799999998, 54.0, 22.0 ],
					"text" : "gate 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 84.25, 369.527557000000002, 42.0, 22.0 ],
					"text" : "* 0.05"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 145.5, 212.305786000000012, 79.0, 22.0 ],
					"text" : "clip 0.0001 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 145.5, 184.139098999999987, 49.0, 22.0 ],
					"text" : "qlim 16"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 145.5, 280.639130000000023, 59.0, 22.0 ],
					"text" : "pow 0.25"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 145.5, 340.305755999999974, 48.0, 22.0 ],
					"text" : "!- 1024"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 235.5, 422.686188000000016, 57.0, 22.0 ],
					"text" : "zl slice 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 145.5, 369.305755999999974, 62.0, 22.0 ],
					"text" : "getcell $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 145.5, 310.305755999999974, 49.0, 22.0 ],
					"text" : "* 1024."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 145.5, 397.683318999999983, 109.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 64.0, 528.188965000000053, 400.0, 52.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 180.5, 110.305786000000012, 28.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
