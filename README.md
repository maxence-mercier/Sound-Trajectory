...
with the support of Tripinlab, UCA (Université Cote d'azur), X2RC2, CTELA, SFM (société française de musicologie) and AFIM (Association française d'informatique musicale). The opening of the Sound Trajectory source code is supported by the ANR-15-IDEX-01 programme as part of Maxence Mercier's doctoral contract in creation/research at the Côte d'Azur University.
